...
if($_POST['submit']=='agregar ciudad'){
	...
	$result = mysql_query($sql);
		...
		echo "              <tr><td class=table_rows align=center colspan=3 style='color:green;font-family:Tahoma;font-size:12px;'>La ciudad se agrego con exito !!!</td></tr>\n";
		echo "            </table>\n";
...
if($_POST['submit']=='borrar ciudad'){
	...
	$sql = "SELECT id FROMlibos WHERE ciudad='".$_POST['id']."'";
	$res = mysql_query($sql);
	if(mysql_num_rows($res)>=1){

		echo "<BR>";
		echo "            <table align=center class=table_border width=40% border=0 cellpadding=3 cellspacing=0>\n";
		echo "              <tr><td class=table_rows align=center colspan=3 style='color:red;font-family:Tahoma;font-size:12px;'>Un libro hace referencia a esta ciudad. Imposible Borrar !!!</td></tr>\n";
		echo "            </table>\n";
	...
	$result = mysql_query($sql);
		echo "<BR>";
		echo "            <table align=center class=table_border width=40% border=0 cellpadding=3 cellspacing=0>\n";
		echo "              <tr><td class=table_rows align=center colspan=3 style='color:red;font-family:Tahoma;font-size:12px;'>La ciudad se borro con exito !!!</td></tr>\n";
		echo "            </table>\n";
	}
}
...
echo "</select></td><td><input type='submit' name='submit' src='images/icons/delete.png' value='borrar ciudad'></td></tr></form></table><br><br>";
