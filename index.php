...
echo "  <tr class=right_main_text><td height=10 align=center valign=top scope=row class=title_underline>Login BIBLIOTECA</td></tr>\n";
...
echo "        <tr class=right_main_text><td align=center>Para loguearse haga click aqui<a class=admin_headings href='login.php'><u><img src='images/icons/223.jpg' border='0'></u></a> </td></tr>\n";
...
//Comentario FOCIM echo "<table width=100% height=89% border=0 cellpadding=0 cellspacing=1>\n";
//Comentario FOCIM echo "  <tr valign=top>\n";
...
//Comentario FOCIM echo "    <td class=middle_main width=60% align=left scope=col>\n";
// centro
//Comentario FOCIM echo "<font size=2 color=black>";
//Comentario FOCIM echo "Bienvenido a la Biblioteca Digital."."<BR><BR>";

//Comentario FOCIM echo "Esta Biblioteca se ha ido formando como producto del acopio y conservación de libros, revistas, manuscritos y toda clase de documentos que han servido de base o apoyo secundario a investigaciones científicas o académicas. El depósito de libros y documentos está por lo tanto clasificado y orientado a la investigación, dando como resultado una organización por Líneas de Investigación, además de la tradicional organización electrónica por categorías como autor, título, editorial, etc."."<BR><BR>";

//Comentario FOCIM echo "Las tres formas como la biblioteca engrandece su acervo de libros y documentos son: <br>
//Comentario FOCIM a) <strong>Compra directa</strong> de materiales en función de investigaciones que se autorizan para alumnos o colaboradores del Instituto<br>
//Comentario FOCIM b) <strong>Donativos</strong> de libros y documentos por parte de catedráticos, casas editoriales, alumnos, colaboradores y amigos.<br>
//Comentario FOCIM c) <strong>Fusiones</strong> de nuestro acervo bibliográfico y hemerográfico con las bibliotecas privadas de catedráticos e instituciones educativas y centros de investigación."."<BR><BR>";

//Comentario FOCIM echo "Nuestra biblioteca es <strong>PRIVADA.</strong> Lo cual implica que únicamente los donadores de obras o colecciones, así como personas e instituciones que han fusionado sus bibliotecas privadas a la nuestra, tienen autorización para utilizar el fondo colectivo que se ha formado desde 1985. La biblioteca no persigue fines de lucro y no cobra por ningún servicio relacionado con el acopio y conservación de estos materiales. Su financiamiento proviene del fondo que destinan para tal efecto las instituciones que la utilizan."."<BR><BR>";

//Comentario FOCIM echo "Exiten RESTRICCIONES para el uso de los libros de esta biblioteca. Están diseñadas para proteger los derechos de autor. Básicamente consisten en que dos lectores no pueden estar utilizando simultáneamente una obra y que éstas no pueden ser descargadas completas ni impresas. Son de sólo lectura. Si el lector copia de manera individual página por página y las imprime lo hace bajo su entera responsabilidad y pierde por ese sólo hecho su derecho a ser lector de esta biblioteca."."<BR><BR>";

//Comentario FOCIM echo "Esta biblioteca está conformada por versiones electrónicas de libros que originalmente fueron publicados en papel o en versiones electrónicas. Cuenta con un acervo de 62,000 obras, de las cuales se han empezado a digitalizar un promedio de 15 obras diarias a partir de junio de 2007. "."<BR><BR>";

//Comentario FOCIM $sql = "SELECT count(id) AS total FROM libros";
//Comentario FOCIM $res = mysql_query($sql);
//Comentario FOCIM $total = mysql_fetch_array($res);
//Comentario FOCIM echo "Actualmente contamos con <strong>".$total['total']."</strong> registros de obras disponibles para su consulta on line."."<BR><BR>";

//Comentario FOCIM echo "Si tienes alguna duda, comentario o sugerencia, comunícate con nosotros por medio de correo electrónico, aquí mismo encontrarás el hipervínculo, en la parte superior de esta página web."."<BR><BR>";
//Comentario FOCIM echo "</font>";
// fin centro
//Comentario FOCIM echo "</td>";

//Comentario FOCIM echo "    <td class=right_main width=20% align=left scope=col>\n";
// derecha
...
//Comentario FOCIM     echo "</table><br>";
}
