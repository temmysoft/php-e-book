...
if(isset($_POST['submit']) && $_POST['submit']=='actualizar libro'){
	...
	if(mysql_num_rows($res)<1){ // problema editorial
		...
		echo "              <tr><td class=table_rows align=center colspan=3 style='color:red;font-family:Tahoma;font-size:12px;'>ERROR: Editorial Invalida !!!</td></tr>\n";
		echo "            </table>\n";
		$error = 1;
	...
	if(mysql_num_rows($res)<1){ // problema pais
		...
		echo "<BR>";
		echo "            <table align=center class=table_border width=40% border=0 cellpadding=3 cellspacing=0>\n";
		echo "              <tr><td class=table_rows align=center colspan=3 style='color:red;font-family:Tahoma;font-size:12px;'>ERROR: Pais Invalido !!!</td></tr>\n";
		echo "            </table>\n";
		$error = 1;
	...
	if(mysql_num_rows($res)<1){ // problema ciudad
		...
		echo "<BR>";
		echo "            <table align=center class=table_border width=40% border=0 cellpadding=3 cellspacing=0>\n";
		echo "              <tr><td class=table_rows align=center colspan=3 style='color:red;font-family:Tahoma;font-size:12px;'>ERROR: Ciudad Invalida !!!</td></tr>\n";
		echo "            </table>\n";
		$error = 1;
...
/*	
	if(!is_numeric($_POST['isbn'])){
		...
		echo "<BR>";
		echo "            <table align=center class=table_border width=40% border=0 cellpadding=3 cellspacing=0>\n";
		echo "              <tr><td class=table_rows align=center colspan=3 style='color:red;font-family:Tahoma;font-size:12px;'>ERROR: El ISBN debe ser numerico solamente !!!</td></tr>\n";
		echo "            </table>\n";
		$error = 1;
...
*/	
	...
	if(mysql_num_rows($res2)>=1){
		...
		echo "<BR>";
		echo "            <table align=center class=table_border width=40% border=0 cellpadding=3 cellspacing=0>\n";
		echo "              <tr><td class=table_rows align=center colspan=3 style='color:red;font-family:Tahoma;font-size:12px;'>ERROR: El ISBN Ya Existe !!!</td></tr>\n";
		echo "            </table>\n";
		$error = 1;
	...
	if($error==0) { // se aceptaron valores
		...
		echo "            <table align=center class=table_border width=40% border=0 cellpadding=3 cellspacing=0>\n";
		echo "              <tr><td class=table_rows align=center colspan=3 style='color:green;font-family:Tahoma;font-size:12px;'>El Libro se ha Actualizado con Exito !!!</td></tr>\n";
		echo "            </table>\n";
...
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Titulo:</td><td colspan=2 width=80%
                      ...
                      size='100' maxlength='100' name='titulo' value='".$_POST['titulo']."'>&nbsp;*</td></tr>\n";
...
echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Observaciones:</td><td colspan=2 width=80%
                      style='color:red;font-family:Tahoma;font-size:10px;padding-left:20px;'><TEXTAREA 
                      cols='30' rows='6' maxlength='50' name='observaciones'>".$_POST['observaciones']."</TEXTAREA>&nbsp;</td></tr>\n";

echo "              <tr><td class=table_rows align=right colspan=3 style='color:red;font-family:Tahoma;font-size:10px;'>*&nbsp;necesarios&nbsp;</td></tr>\n";
echo "            </table>\n";
